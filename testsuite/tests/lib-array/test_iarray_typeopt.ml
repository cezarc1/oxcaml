...
(let (arr/404 =[value<intarray>] (makearray_imm[int] 1 2 3))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "arr" arr/404))
val arr : int iarray = [:1; 2; 3:]
|}];;

let _ = arr.:(1);;
[%%expect {|
(let (arr/404 =? (apply[unyielding] (field_imm 0 (global Toploop!)) "arr"))
...
(let (arr/406 =[value<intarray>] (makearray_imm[int] 1 2 3))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "arr" arr/406))
val arr : int alias = [:1; 2; 3:]
|}];;

let _ = arr.:(1);;
[%%expect {|
(let (arr/406 =? (apply[unyielding] (field_imm 0 (global Toploop!)) "arr"))
...
(let (mut_arr/407 =[value<intarray>] (makearray[int] 1 2 3))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "mut_arr" mut_arr/407))
val mut_arr : int array = [|1; 2; 3|]
(let
  (mut_arr/407 =?
     (apply[unyielding] (field_imm 0 (global Toploop!)) "mut_arr")
   arr/408 =[value<intarray>]
     (apply[unyielding] (field_imm 13 (global Stdlib_stable__IarrayLabels!))
       mut_arr/407))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "arr" arr/408))
val arr : int iarray = [:1; 2; 3:]
|}];;

let _ = arr.:(1);;
[%%expect {|
(let (arr/408 =? (apply[unyielding] (field_imm 0 (global Toploop!)) "arr"))
...
(let (arr/410 =[value<intarray>] (makearray_imm[int] 1 2 3))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "arr" arr/410))
val arr : int alias = [:1; 2; 3:]
|}];;

let _ = arr.:(1);;
[%%expect {|
(let (arr/410 =? (apply[unyielding] (field_imm 0 (global Toploop!)) "arr"))
...
(let (mut_arr/411 =[value<intarray>] (makearray[int] 1 2 3))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "mut_arr" mut_arr/411))
val mut_arr : int array = [|1; 2; 3|]
(let
  (mut_arr/411 =?
     (apply[unyielding] (field_imm 0 (global Toploop!)) "mut_arr")
   arr/412 =[value<intarray>]
     (apply[unyielding] (field_imm 13 (global Stdlib_stable__IarrayLabels!))
       mut_arr/411))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "arr" arr/412))
val arr : int iarray = [:1; 2; 3:]
|}];;

let _ = arr.:(1);;
[%%expect {|
(let (arr/412 =? (apply[unyielding] (field_imm 0 (global Toploop!)) "arr"))
...
(let (arr/414 =[value<intarray>] (makearray_imm[int] 1 2 3))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "arr" arr/414))
val arr : int alias = [:1; 2; 3:]
|}];;

let _ = arr.:(1);;
[%%expect {|
(let (arr/414 =? (apply[unyielding] (field_imm 0 (global Toploop!)) "arr"))
...
(let (mut_arr/415 =[value<intarray>] (makearray[int] 1 2 3))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "mut_arr" mut_arr/415))
val mut_arr : int array = [|1; 2; 3|]
(let
  (mut_arr/415 =?
     (apply[unyielding] (field_imm 0 (global Toploop!)) "mut_arr")
   arr/416 =[value<intarray>]
     (apply[unyielding] (field_imm 13 (global Stdlib_stable__IarrayLabels!))
       mut_arr/415))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "arr" arr/416))
val arr : int iarray = [:1; 2; 3:]
|}];;

let _ = arr.:(1);;
[%%expect {|
(let (arr/416 =? (apply[unyielding] (field_imm 0 (global Toploop!)) "arr"))
...
(let (arr/418 =[value<intarray>] (makearray_imm[int] 1 2 3))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "arr" arr/418))
val arr : int alias = [:1; 2; 3:]
|}];;

let _ = arr.:(1);;
[%%expect {|
(let (arr/418 =? (apply[unyielding] (field_imm 0 (global Toploop!)) "arr"))
...
(let (mut_arr/419 =[value<intarray>] (makearray[int] 1 2 3))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "mut_arr" mut_arr/419))
val mut_arr : int array = [|1; 2; 3|]
(let
  (mut_arr/419 =?
     (apply[unyielding] (field_imm 0 (global Toploop!)) "mut_arr")
   arr/420 =[value<intarray>]
     (apply[unyielding] (field_imm 13 (global Stdlib_stable__IarrayLabels!))
       mut_arr/419))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "arr" arr/420))
val arr : int iarray = [:1; 2; 3:]
|}];;

let _ = arr.:(1);;
[%%expect {|
(let (arr/420 =? (apply[unyielding] (field_imm 0 (global Toploop!)) "arr"))
...
(let (arr/422 =[value<intarray>] (makearray_imm[int] 1 2 3))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "arr" arr/422))
val arr : int alias = [:1; 2; 3:]
|}];;

let _ = arr.:(1);;
[%%expect {|
(let (arr/422 =? (apply[unyielding] (field_imm 0 (global Toploop!)) "arr"))
...
(let (mut_arr/423 =[value<intarray>] (makearray[int] 1 2 3))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "mut_arr" mut_arr/423))
val mut_arr : int array = [|1; 2; 3|]
(let
  (mut_arr/423 =?
     (apply[unyielding] (field_imm 0 (global Toploop!)) "mut_arr")
   arr/424 =[value<intarray>]
     (apply[unyielding] (field_imm 13 (global Stdlib_stable__IarrayLabels!))
       mut_arr/423))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "arr" arr/424))
val arr : int iarray = [:1; 2; 3:]
|}];;

let _ = arr.:(1);;
[%%expect {|
(let (arr/424 =? (apply[unyielding] (field_imm 0 (global Toploop!)) "arr"))
...
(let (mut_arr/425 =[value<intarray>] (makearray[int] 1 2 3))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "mut_arr" mut_arr/425))
val mut_arr : int array = [|1; 2; 3|]
|}]
...
(let (mut_arr/479 =[value<intarray>] (makearray[int] 1 2 3))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "mut_arr" mut_arr/479))
...
(let (arr/480 =[value<intarray>] (makearray_imm[int] 1 2 3))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "arr" arr/480))
val arr : int iarray = [:1; 2; 3:]
(let
  (arr/480 =? (apply[unyielding] (field_imm 0 (global Toploop!)) "arr")
   mut_arr/481 =[value<intarray>]
     (apply[unyielding] (field_imm 12 (global Stdlib_stable__IarrayLabels!))
       arr/480))
  (apply[unyielding] (field_imm 1 (global Toploop!)) "mut_arr" mut_arr/481))
val mut_arr : int array = [|1; 2; 3|]
|}];;
